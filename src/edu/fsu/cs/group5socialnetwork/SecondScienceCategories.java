...
public class SecondScienceCategories extends Activity {
	...
	@Override public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.second_science_list);
	...
	public void myNewCategoryHandler(View v){
		if (mCatName.getText().toString() != null) {
			Toast.makeText(SecondScienceCategories.this, "New Category Added!", Toast.LENGTH_SHORT).show();
		...
		MobDB.getInstance().execute(APP_KEY, null, data, null, false, new MobDBResponseListener() {
			...
			public void mobDBResponse(Vector<HashMap<String, Object[]>> result) {
				...
				if (result.size() > 0) { 
					...
					ArrayAdapter<String> adapter = new ArrayAdapter<String>(SecondScienceCategories.this, android.R.layout.simple_list_item_1, android.R.id.text1, toAdd);
